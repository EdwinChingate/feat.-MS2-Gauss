...
def ResolveFullChromatogram(mz,mz_std,AllPeaks,stdDistance=3,RT_tol=5,minSignals=5,SavePeaks=True,mz_name='mz'):
    ChromatogramList=AllSubChromatograms(mz=mz,mz_std=mz_std,AllPeaks=AllPeaks,stdDistance=stdDistance,RT_tol=RT_tol,minSignals=minSignals)
