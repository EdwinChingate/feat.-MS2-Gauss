...
def ms2_SpectralRedundancy(SummaryFile,min_RT=0,max_RT=1500,min_mz=0,max_mz=1200,ms2FolderName='ms2_spectra',ToReplace='mzML-ms2Summary.xlsx',mz_col=1,RT_col=2,minRT_col=12,maxRT_col=13,RT_tol=20,mz_Tol=1e-2,sample_id_col=-1,ms2_spec_id_col=0,ToAdd='mzML',min_Int_Frac=2,cos_tol=0.9):
    home=os.getcwd()
    ...
    Modules=ms2_SpectralSimilarityClustering(SummMS2_raw=SummMS2_raw,SampleName=SampleName,mz_col=mz_col,RT_col=RT_col,minRT_col=minRT_col,maxRT_col=maxRT_col,RT_tol=RT_tol,mz_Tol=mz_Tol,sample_id_col=sample_id_col,ms2_spec_id_col=ms2_spec_id_col,ms2Folder=ms2Folder,ToAdd=ToAdd,min_Int_Frac=min_Int_Frac,cos_tol=cos_tol)
